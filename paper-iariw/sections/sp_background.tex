\section{Background: calibration and record selection}
...
sweep (Section~\ref{sp:sec:future_work}). A raking-then-TRS variant is the corresponding classical baseline
...
an analogous penalty method worth testing directly in future work (Section~\ref{sp:sec:future_work}), where
...
Section~\ref{sp:sec:data} describes the pipeline and the configuration used here.
