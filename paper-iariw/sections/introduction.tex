...
\begin{figure}[t]
  ...
  \caption{The two-stage pipeline. Survey and administrative sources
  feed a weighted, gated, chained imputation stage; the enhanced
  candidate file then passes through target-informed $L_0$ selection
  and calibration to produce a sparse, simulable, geography-consistent
  release.}
  \label{fig:pipeline}
\end{figure}
