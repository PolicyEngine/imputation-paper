\subsection{Background: imputation for microsimulation}
\label{imp:sec:background}

\subsubsection{Imputation methods in survey practice}
...
\subsubsection{Chained imputation and joint structure}
...
\subsubsection{Weights in imputation}
...
\subsubsection{Evaluating imputed files}
...
calibration \citep{koenker2005quantile, meinshausen2006quantile} and use
Wasserstein distance for marginal fit. For the joint, the evaluation
...
against realized samples \citep{gneiting2007strictly, szekely2013energy}, and
the precision--recall--density--coverage geometry of generative-model
