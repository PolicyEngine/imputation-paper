...
US fiscal build. Every target is a source-backed fact from \policyengine{} \chronicle{} \citep{ledger2026}, the
\chronicle{} fact store that holds the source publications and preserves the provenance of each
