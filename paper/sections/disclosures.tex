...
A full acknowledgments and funding statement will appear in the final
version.
...
open source at \url{https://github.com/PolicyEngine/microcosm}. Baseline
...
against \populacefit{} at commit \texttt{71b5a83} of the \populace{}
repository (then named \texttt{populace}, whose distribution the pinned
commit ships as \texttt{populace-fit}),
